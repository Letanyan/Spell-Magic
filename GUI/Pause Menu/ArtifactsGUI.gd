...
func filter_update_popup_menu_items(menu: PopupMenu, option: int) -> void:
	...
	if option == 1: # Event
		...
		menu.add_separator()
		menu.add_icon_check_item(preload("res://GUI/Images/triangle.png"), "Triangle", Artifact.Pattern.TRIANGLE + 6)
		menu.add_icon_check_item(preload("res://GUI/Images/square.png"), "Square", Artifact.Pattern.SQUARE + 6)
		menu.add_icon_check_item(preload("res://GUI/Images/circle.png"), "Circle", Artifact.Pattern.CIRCLE + 6)
		menu.add_separator()
		...
		menu.add_separator()
		menu.add_icon_check_item(preload("res://GUI/Images/triangle.png"), "Triangle", Artifact.Pattern.TRIANGLE + 8)
		menu.add_icon_check_item(preload("res://GUI/Images/square.png"), "Square", Artifact.Pattern.SQUARE + 8)
		menu.add_icon_check_item(preload("res://GUI/Images/circle.png"), "Circle", Artifact.Pattern.CIRCLE + 8)
		menu.add_separator()
