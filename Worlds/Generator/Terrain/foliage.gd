...
static var base_shapes := {
	...
	World.Foliage.TREE_PINE: ShapeTemplate.capsule(0.75, 3.0, Transform3D(Basis(Quaternion(0, 0, 0, 1)), Vec3.y(1.25))),	
	World.Foliage.TREE_SAFARI2: ShapeTemplate.capsule(0.5, 2.0, Transform3D(Basis(Quaternion(0, 0, 0, 1)), Vec3.y(1.0))),	
}
