...
static var notes := {
	...
	"spell Elemental Application": "Certain elements have additional effects. Namely {[color=#FF0000]Fire[/color]} applies {Burn}, {[color=#0080FF]Water[/color]} applies {[color=#0080FF]Wet[/color]}, {[color=#00FFFF]Ice[/color]} applies {[color=#00FFFF]Freeze[/color]}, {[color=#FF0080]Electric[/color]} applies {[color=#FF0080]Stun[/color]} and {[color=#00FF80]Wind[/color]} applies {[color=#00FF80]Feather[/color]}.",
	...
	"spell Environment Effects": "Some environments have effects that can effect your spells or effect you. Some effects may by evaporating {[color=#0080FF]Water[/color]} spells or {[color=#00FF80]Wind[/color]} spells knocking you back. Status effects such as having {[color=#00FFFF]Freeze[/color]} or {[color=#0080FF]Wet[/color]} applied to you may also occur.",
	"spell Burning": "{[color=#FF0000]Burning[/color]} applies damage over time. The damage is proportional to the amount of {[color=#FF0000]Burning[/color]} applied. Applying {[color=#0080FF]Wet[/color]}, {[color=#00FFFF]Freeze[/color]}, and/or {[color=#FF0080]Stun[/color]} will reduce the amount of {[color=#FF0000]Burning[/color]}. {{[color=#0080FF]Wet[/color]}} and {[color=#00FFFF]Freeze[/color]} will decrease the damage done by the {[color=#0080FF]Water[/color]} and {[color=#00FFFF]Ice[/color]} spells, where as, {[color=#FF0080]Stun[/color]} will incease the damage of the {[color=#FF0080]Electric[/color]} spell. Applying {[color=#00FF80]Wind[/color]} will increase the amount of {[color=#FF0000]Burning[/color]}.",
	"spell Wet": "{[color=#0080FF]Wet[/color]} on an enemy increase the effects of {[color=#FF0000]Fire[/color]}, {[color=#00FFFF]Ice[/color]} and {[color=#FF0080]Electric[/color]} spells. When an {[color=#00FFFF]Ice[/color]} spell hits a {[color=#0080FF]Wet[/color]} character the amount of {[color=#00FFFF]Freeze[/color]} increase proportionally to the amount of {[color=#0080FF]Wet[/color]}. For {[color=#FF0080]Electric[/color]} spells the hit area of a character increase by how {[color=#0080FF]Wet[/color]} said character is and the amount of {[color=#FF0080]Stun[/color]} is increased. The damage done by {[color=#FF0000]Fire[/color]} attacks scales by the amount of {[color=#0080FF]Wet[/color]} on a character. {[color=#00FF80]Wind[/color]} spells will decrease the amount of {[color=#0080FF]Wet[/color]}.",
	"spell Freeze": "Characters with {[color=#00FFFF]Freeze[/color]} will slow down. This slow down is proportional to the amount of {[color=#00FFFF]Freeze[/color]}. A {[color=#0080FF]Wet[/color]} character when hit with {[color=#00FFFF]Ice[/color]} will increase its amount of {[color=#00FFFF]Freeze[/color]} faster. Characters with {[color=#00FFFF]Freeze[/color]} that are hit by {[color=#FF0080]Electric[/color]} spells will have an increased {[color=#FF0080]Stun[/color]} effect. The damage done by {[color=#FF0000]Fire[/color]} attacks scales by the amount of {[color=#00FFFF]Freeze[/color]} on a character. {[color=#00FF80]Wind[/color]} spells will decrease the amount of {[color=#00FFFF]Freeze[/color]}.",
	"spell Stun": "{[color=#FF0080]Stun[/color]} shocks a character still for a small period of time. The amount of time scales with the amount of {[color=#FF0080]Stun[/color]}.",
	"spell Feather": "{[color=#00FF80]Feather[/color]} reduces the weight of a character to the {[color=#00FF80]Wind[/color]} attack being applied. Increasing the amount of {[color=#00FF80]Feather[/color]} increases the push applied.",
