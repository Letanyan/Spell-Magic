...
@export_flags_3d_physics var moving_platform_layers : int = 0
## Collision layers that will be included for detecting wall and ceiling bodies that will 
## accelarate the body.
@export_flags_3d_physics var moving_wall_and_ceiling_layers : int = 0
...
@export var interact_with_rigid_bodies : bool = false
