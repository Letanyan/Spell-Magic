...
func setup(seedling: int, biome: World.Biome) -> void:
	...
	var rotate_path := Pathway.new() \
		.move_to(a) \
		.arc_to(a.rotated(Vector3.UP, PI / 2) + Vector3(0, 10, 0), true, runs(8), Easing.linear) \
		.arc_to(a.rotated(Vector3.UP, PI) + Vector3(0, 20, 0), true, runs(8), Easing.linear) \
		.arc_to(a.rotated(Vector3.UP, PI / 2 * 3) + Vector3(0, 30, 0), true, runs(8), Easing.linear) \
		.arc_to(a  + Vector3(0, 40, 0), true, runs(8), Easing.linear) \
		.arc_to(a.rotated(Vector3.UP, PI / 2) + Vector3(0, 30, 0), true, runs(8), Easing.linear) \
		.arc_to(a.rotated(Vector3.UP, PI) + Vector3(0, 20, 0), true, runs(8), Easing.linear) \
		.arc_to(a.rotated(Vector3.UP, PI / 2 * 3) + Vector3(0, 10, 0), true, runs(8), Easing.linear) \
		.arc_to(a  + Vector3(0, 40, 0), true, runs(8), Easing.linear)
	...
	artifact_drop_probs = {
		...
		"E": {
			"effect": { Artifact.Effect.RESISTANCE_FLAT: 10, Artifact.Effect.RESISTANCE_PERCENTAGE: 10 },
			"element": { Artifact.Element.ICE: 5, Artifact.Element.DURATION: 10, Artifact.Element.ANY: 1,  },
			"pattern": { Artifact.Pattern.CIRCLE: 2 },
			"tier": artier(12),
		},
		"S": {
		...
		"W": {
			"effect": { Artifact.Effect.RESISTANCE_FLAT: 10, Artifact.Effect.RESISTANCE_PERCENTAGE: 10 },
			"element": { Artifact.Element.ICE: 5, Artifact.Element.POWER: 10, Artifact.Element.ANY: 1,  },
			"pattern": { Artifact.Pattern.CIRCLE: 2 },
			"tier": artier(12),
		},
	}
